...
def CreateCube(pSdkManager, pName):
    ...
    vtxcLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByControlPoint)
    vtxcLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eDirect)
    ...
    pgrpLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygon)
    pgrpLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndex)
    ...
    uvLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygon)
    uvLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndexToDirect)
    ...
    texLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygon)
    texLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndexToDirect)
    texLayer.GetDirectArray().Add(lTexture)
    for index in range(6):
        texLayer.GetIndexArray().Add(0)

    layer.SetTextures(FbxLayerElement.EType.eTextureDiffuse,texLayer)
    ...
    uvLayer = FbxLayerElementUV.Create(lMesh, "")
    uvLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygonVertex)
    uvLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndexToDirect)
    ...
    texLayer =  FbxLayerElementTexture.Create(lMesh, "")
    texLayer.SetBlendMode(FbxLayerElementTexture.EBlendMode.eModulate)
    texLayer.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygon)
    texLayer.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndexToDirect)
    texLayer.GetDirectArray().Add(lTexture)
    ...
    uvLayer1.SetMappingMode(FbxLayerElement.EMappingMode.eByPolygonVertex)
    uvLayer1.SetReferenceMode(FbxLayerElement.EReferenceMode.eIndexToDirect)
    for index in range(4):
